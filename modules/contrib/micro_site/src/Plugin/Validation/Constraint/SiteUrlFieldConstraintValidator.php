...
class SiteUrlFieldConstraintValidator extends ConstraintValidator {
  ...
  public function validate($entity, Constraint $constraint) {
    ...
    // Reserved keywords for master host.
    $keywords = ['host', 'localhost', 'www', 'dev', 'stage', 'preprod'];
    $keywords_reserved = Settings::get('micro_site.master_reserved_keywords');
    if ($keywords_reserved !== NULL && is_array($keywords_reserved)) {
